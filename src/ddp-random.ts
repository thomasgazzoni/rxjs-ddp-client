...
var RandomGenerator = function (seedArray = undefined) {
    var self = this;
...
var agent = (typeof navigator !== 'undefined' && navigator.userAgent) || '';
 ...
 export var ddpRandom: any;

if (nodeCrypto || (typeof window !== 'undefined' && window.crypto && window.crypto.getRandomValues)) {
    ddpRandom = new RandomGenerator();
} else {
    ddpRandom = new RandomGenerator([new Date(), height, width, agent, Math.random()]);
}

ddpRandom.createWithSeeds = function () {
